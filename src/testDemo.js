...
class Text extends React.Component {
    constructor() {
        ...
        this.state = {
            msg: 'well',
            show: false,
            arr: [{id: 1, name: "ww", age: 221}, {id: 2, name: "zz", age: 25}, {id: 3, name: "tt", age: 2}, {
                id: 4,
                name: "gg",
                age: 12
            }, {id: 5, name: "ss", age: 33}]
...
class SyncInput extends React.Component {
    ...
    render() {
        ...
        return (
            <div>
                <input ref="inputV" type="text" defaultValue={this.state.text} onChange={this.change.bind(this)}/>
                <button onClick={this.add.bind(this)} className="add-btn">添加</button>
...
class Drap extends React.Component {
    ...
    render() {
        return (
            <div className="box-drap" style={{left: this.state.left, top: this.state.top}}
                 onMouseDown={this.down.bind(this)}>可以拖拽</div>
        )
    }
                ...
                <List renderHeader={() => '幽默段子'} renderFooter={() => '幽默段子结尾'}>
                    {
                        this.state.data.map((item, index) => {
                            return <Item platform="android" onClick={() => {
                            }} arrow="down" key={index}>{index + 1}--{item.content}</Item>
                        })
                    }
                </List>
            </React.Fragment>
        ...
        return (
            <React.Fragment>
                ...
                <ul className="bg">{/*activeStyle={{color: 'red'}}*/}
                    ...
                    <li><NavLink to='/MapList'>MapList</NavLink></li>
